...
version: "0.0.1"
description: >
  Execute complex coding-agent work through SignalCore's pre-release local runtime:
...
SignalCore is a local-first runtime-control plane and Agent Skill. Correctness, exact evidence, security boundaries and required verification outrank token reduction.
...
Use `python -m signalcore_runtime --help` for the complete runtime surface.
