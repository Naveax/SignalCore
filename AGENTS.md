# SignalCore repository instructions

Use `skills/signal-core/SKILL.md` for complex coding-agent work involving repository exploration, debugging, impact analysis, large outputs, long sessions, tool overload, or token/cost analysis.
