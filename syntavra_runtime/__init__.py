"""Syntavra v0.0.1 pre-release unified dominance runtime."""
...
if _os.environ.get("SYNTAVRA_PORTABLE_BOOTSTRAP") == "1":
    ...
    from .production_extension import install as _install_v6_extension
    ...
    from .platform import (
        ADAPTERS, AdapterContract, CapabilityDecision, CapabilitySecurity,
        SyntavraPlatform, ArtifactStore, ContextCompiler, ContextIRItem,
        ContextPack, FirewallReceipt, IncrementalCodeIntelligenceGraph, CodingAgent,
        SecretlessProviderGateway, SessionMemory, AdapterRegistry,
        OutputFirewall, manifest as platform_manifest,
    )
    ...
    __all__ = [
        ...
        "ServiceSpec", "SessionAnalyticsStore", "SessionContinuityController", "SyntavraClient",
        "StateBackupManager", "SemanticGraph", "SuperiorityGate", "ToolRouteDecision",
        ...
        "ADAPTERS", "AdapterContract", "CapabilityDecision", "CapabilitySecurity",
        "SyntavraPlatform", "ArtifactStore", "ContextCompiler",
        "ContextIRItem", "ContextPack", "FirewallReceipt", "IncrementalCodeIntelligenceGraph",
        "CodingAgent", "SecretlessProviderGateway", "SessionMemory",
        "AdapterRegistry", "OutputFirewall", "platform_manifest",
    ]
