...
DEFAULT_ARMS = ("plain-baseline", "signalcore", "token-savior", "context-mode", "headroom", "volt-lcm")
...
class SuperiorityGate:
    ...
    @classmethod
    def evaluate(cls, receipts: Iterable[dict[str, Any]], *, candidate: str = "signalcore", baseline: str = "plain-baseline") -> dict[str, Any]:
        rows = list(receipts)
        reasons: list[str] = []
