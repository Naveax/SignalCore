...
class LiveIntegrationReceipt:
    ...
    family: str
    observed_at: str
    signalcore_version: str
    signalcore_channel: str
    adapter_version: str
    ...
    def from_mapping(cls, value: Mapping[str, Any]) -> "LiveIntegrationReceipt":
        return cls(
            ...
            signalcore_version=str(value.get("signalcore_version", "")),
            signalcore_channel=str(value.get("signalcore_channel", "")),
    ...
    def validate(self) -> tuple[str, ...]:
        ...
        if self.signalcore_version != VERSION:
            reasons.append("version-mismatch")
        if self.signalcore_channel != CHANNEL:
