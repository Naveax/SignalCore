...
class WorkloadSpec:
    ...
    repetitions: int = 30
    competitor_arms: tuple[str, ...] = ("baseline", "signalcore", "headroom", "context-mode", "token-savior", "volt-lcm")
...
DISTRIBUTIONS: tuple[DistributionTarget, ...] = (
    DistributionTarget("pypi", "signalcore-runtime", True, True),
    DistributionTarget("npm", "@signalcore/client", True, True),
    DistributionTarget("ghcr", "signalcore/runtime", True, True),
    DistributionTarget("homebrew", "signalcore", True, True),
    DistributionTarget("winget", "SignalCore.SignalCore", True, True),
