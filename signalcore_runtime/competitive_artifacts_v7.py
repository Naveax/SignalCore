...
class ContentAddressedArtifactStoreV2:
    ...
    def __init__(self, root: Path):
        ...
        self.db_path = root / "artifacts-v2.sqlite3"
...
class UniversalOutputFirewallV2:
    """Typed pre-context output interception with exact recovery."""

    def __init__(self, store: ContentAddressedArtifactStoreV2):
        self.store = store
...
class ContextCompilerV2:
    ...
    def __init__(self, store: ContentAddressedArtifactStoreV2):
        self.store = store
        self.firewall = UniversalOutputFirewallV2(store)
